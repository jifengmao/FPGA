...
HD_PWD='C:/Users/maoji/Work/FPGA_Projects/Basys_ACL/Pmod_Verilog/PmodACL_Verilog/PmodACL_Verilog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodACL_Demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PmodACL_Demo.tcl
