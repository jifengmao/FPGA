...
HD_PWD='C:/Users/maoji/Work/FPGA_Projects/Basys_ACL/Pmod_Verilog/PmodACL_Verilog/PmodACL_Verilog.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodACL_Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PmodACL_Demo.tcl -notrace
